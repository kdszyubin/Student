...
StudentDoc.h、StudentDoc.cpp - 文档
    这些文件包含 CStudentDoc 类。编辑这些文件以添加特殊文档数据并实现文件保存和加载（通过 CStudentDoc::Serialize）。

StudentView.h、StudentView.cpp - 文档视图
    这些文件包含 CStudentView 类。
    CStudentView 对象用于查看 CStudentDoc 对象。
